...
data = [[0,
         "Название",
         "поездка предназначена исключительно для искстных ездаков, сложность:4/10",
         [[55.689179, 37.772682],
          [55.690211, 37.784942],
          [55.687925, 37.801329],
          [55.687321, 37.804719],
        ...
        [1,
         "Название",
         "поездка предназначена исключительно для искстных ездаков, сложность:6/10",
         [[55.689179, 37.772682],
          [55.690211, 37.784942],
          [55.687925, 37.801329],
          [55.687321, 37.804719],
        ...
        [2,
         "Название",
         "поездка предназначена исключительно для искстных ездаков, сложность:8/10",
         [[55.689179, 37.772682],
          [55.690211, 37.784942],
          [55.687925, 37.801329],
          [55.687321, 37.804719],
...
@app.route('/make')  # первое что видишь (должно быть (войти, искать путь, создать свой;не работает;))
def make():
    return render_template('registr.html', Title='Гость')
...
def find():  # поиск пути по критериям
    ...
    return render_template('finder.html', data=data)
